...
class Collector:
    ...
    def Clear(self):
        if self.CurrentSample==1 and GPIO.input(self.Sensor1)==GPIO.LOW and GPIO.input(self.Sensor2)==GPIO.LOW and GPIO.input(self.Sensor3)==GPIO.LOW and GPIO.input(self.Sensor4)==GPIO.LOW:
            self.clear=1
        elif self.CurrentSample==2 and GPIO.input(self.Sensor2)==GPIO.LOW and GPIO.input(self.Sensor3)==GPIO.LOW and GPIO.input(self.Sensor4)==GPIO.LOW:
            self.clear=1
        elif self.CurrentSample==3 and GPIO.input(self.Sensor3)==GPIO.LOW and GPIO.input(self.Sensor4)==GPIO.LOW:
            self.clear=1
        elif self.CurrentSample==4 and GPIO.input(self.Sensor4)==GPIO.LOW:
            self.clear=1
        else:
            self.clear=0
    def CheckSample(self):
        if self.CurrentSample==1 and GPIO.input(self.Sensor1)==GPIO.HIGH and self.clear == 1:
            ...
            self.ChangeSample()
            #self.Clear()
        elif self.CurrentSample==2 and GPIO.input(self.Sensor2)==GPIO.HIGH and self.clear == 1:
            ...
            self.ChangeSample()
            #self.Clear()
        elif self.CurrentSample==3 and GPIO.input(self.Sensor3)==GPIO.HIGH and self.clear == 1:
            ...
            self.ChangeSample()
            #self.Clear()
        elif self.CurrentSample==4 and GPIO.input(self.Sensor4)==GPIO.HIGH and self.clear == 1:
