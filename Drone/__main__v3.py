...
##--------------------------------------------------------------      
            ...
            #send_ned_velocit(x,y,z,duration)
            # velocity_x > 0 => fly North in metres/second
            ...
            # velocity_z > 0 => descend
                ...
                #vehicle.send_ned_velocit(0,0.1,0,10)
            #elif Pixel_X_difference<=0:#left
                #vehicle.send_ned_velocit(0,-0.1,0,10)
            #if Pixel_Y_difference>=0: #backward
                #vehicle.send_ned_velocit(-0.1,0,0,10)
            ...
            ##     
            ##--------------------------------------------------------------
            if collector1.CurrentSample ==1:
                ##
                center_X = (Original_width/2)
                center_Y = (Original_height/2) - 3*(1786.571/altitude) #3 is 3cm from centre
                ##
                while abs(differece_X) >= 5:
